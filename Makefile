...
SOURCES=bloques.c ficheros_basico.c ficheros.c directorios.c mi_mkfs.c leer_sf.c mi_cat.c mi_chmod.c mi_escribir.c mi_ls.c mi_mkdir.c mi_stat.c mi_touch.c mi_link.c mi_rm.c#todos los .c
